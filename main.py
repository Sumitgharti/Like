...
Status: {status}
[FFDD00]°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°
[00FF00][b][c]BOT MADE BY SURAJ MODZ 
"""
            else:
...
[C][B][11EAFD]‎━━━━━━━━━━━━
[C][B][FFB300]Subscribe: [FFFFFF]SURAJ MODZ [00FF00]!!
"""
...
[FF0000]╠══════════╣
[FFD700]⚡ OWNER : [FFFFFF]SURAJ MODZ    
[FFD700]✨ কেউ GUILD BOT কিনতে চাইলে telegram এ message করবেন, telegram username @surajxmodz ❤️  
[FF0000]╚══════════╝
[FFD700]✨ Developer —͟͞͞ </> SURAJ MODZ ❄️  ⚡
"""
                        ...
                        if inPuTMsG.strip().startswith('/room'):
                            ...
                            if len(parts) < 2:
                                ...
                                try:
                                    ...
                                    # Create spam packet
                                    spam_packet = await Room_Spam(target_uid, room_id, "SURAJ MODZ", key, iv)
...
# IMPROVED TREE-STYLE HELP MENU SYSTEM (Commands in their original menus) 🌳
                        if inPuTMsG.strip().lower() in ("help", "/help", "menu", "/menu", "commands"):
                            ...
                            # Header
                            header = f"[b][c]{get_random_color()}Hey User Welcome To ANUP GAMER BOT"
...
async def MaiiiinE():
    Uid , Pw = '4427919843','967882C972DAFA8CC5BB0045AF9BAC43275A6D6289B7FCEA0D23687E8DA28D9A'
    ...
    os.system('clear')
    print("Initializing SURAJ MODZ Bot...")
    print("┌────────────────────────────────────┐")
    print("│ █████████████░░░░░░░░░░░░░░░░░░ │")
    print("└────────────────────────────────────┘")
    time.sleep(0.5)
    ...
    os.system('clear')
    print(render('SURAJ MODZ', colors=['white', 'green'], align='center'))
    print('')
    print("🤖 SURAJ MODZ BOT - ONLINE")
    print(f"🔹 UID: {TarGeT}")
    print(f"🔹 Name: {acc_name}")
...
def handle_keyboard_interrupt(signum, frame):
    ...
    print("👋 Thanks for using our SURAJ MODZ BOT")
    sys.exit(0)
